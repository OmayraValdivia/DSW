...
<div class="card card-body bg-light mt-3">
    <h2>Eliminar Libro del Usuario</h2>
    <form action="<?php echo RUTA_URL; ?>/wrapups/del/<?php echo $datos['book_id'];?>-<?php echo $datos['user_id'];?>" method="POST">
        ...
        <div class="form-group">
    		...
    		<input type="number" disabled name="mark" class="form-control form-control-lg" value="<?php echo $datos['mark'];?>">
    	</div>
        <input type="hidden" name="user_id" value="<?php echo $datos['user_id'];?>">
    	<input type="submit" class="btn btn-success" value="Eliminar Libro del Usuario">
    </form>
</div>
